  ...
  return (
    <div className="input-right">
      ...
      <svg onClick={onChange} width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M0.5 4V14C0.5 15.6569 1.84315 17 3.5 17H13.5C15.1569 17 16.5 15.6569 16.5 14V4C16.5 2.34315 15.1569 1 13.5 1H3.5C1.84315 1 0.5 2.34315 0.5 4Z" stroke="#777" strokeWidth="1.15" />
